            ...
            <div class="card">
                ...
                <div class="card-body">
                                    ...
                                    @foreach($units->where('o_id',$spec->o_id)->where('s_id',$spec->s_id) as $unit)
                                           <tr>
                                              ...
                                              <td>
                                                  ...
                                                  <form method="post" action="{{route('update.print')}}">@csrf
                                              ...
                                              <td>
                                                  ...
                                                  <form method="post" action="{{route('update.print')}}">
                                                  @csrf 
                            ...
                            <form method="post" action="{{route('update.print')}}">@csrf
                             ...
                             <center><button type="submit" class="btn btn-primary edit" >Ready to Sew</button></center>                          
                            @endif                                              
                                </div>                                
                            </div>
                         @endforeach
