...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            {!! Form::open(array( 'route'=>'admin_new_order', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'onsubmit' => 'return confirm("Confirm submit your order?");')) !!}
                        ...
                        <div class="col-sm-4">
                            <select name="designer" id="designer" class="custom-select custom-select-sm" required>
                                @if(count($designers) > 0)
                                    <option value="" selected disabled>--Please select designer--</option>
                                    @foreach ($designers as $designer)
                                        <option value="{{ $designer->u_id }}">{{ $designer->username }}</option>
                                    @endforeach
                                @else
